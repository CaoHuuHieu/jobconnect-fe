        ...
        <div className="flex justify-between items-center h-[73px] border-b-1 border-neutral-400">
            ...
            <div className="h-full">
                <div className="flex items-center h-full">
                    <div className="pr-[20px] h-full">
                        {isLogin ?
                            ...
                            <div className='flex h-full'>
                                <div className="group mx-[20px]  h-full flex items-center text-zinc-900 relative border-b-2 border-transparent hover:border-(--color-main-color)">
                                    <a className="pt-[24px] pb-[4px] px-[8px] rounded-lg hover:bg-cyan-100" href="#">
                                ...
                                <div  ref={refAccountIcon}   onClick={() => setShowAccountDropdown((prev) => !prev)}
                    ...
                    <div className="pt-[16px] h-full flex items-center mx-[20px] border-b-2 border-transparent hover:border-(--color-main-color) employer relative">
                        <a className="" href="#">Employers / Post Job</a>
                    </div>
                </div>
            </div>
        </div>
